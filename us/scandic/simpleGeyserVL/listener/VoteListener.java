...
public class VoteListener implements Listener
{
	...
	private static String VoteCommandMessage= "(null)";
	private static boolean VoteCommand;
	...
	void loadConfig()
	{
		...
		setVoteCommand(file.getBoolean("vote-command"));
		setVoteCommandMessage(file.getString("vote-command-message"));
		...
		Plugin.log("Loaded vote command msg: " + VoteCommandMessage);
	}
	...
	public static boolean isVoteCommand() {
		return VoteCommand;
	}

	public void setVoteCommand(boolean voteCommand) {
		VoteCommand = voteCommand;
	}

	public static String getVoteCommandMessage() {
		return VoteCommandMessage;
	}

	public void setVoteCommandMessage(String voteCommandMessage) {
		VoteCommandMessage = voteCommandMessage;
	}
}
